...
namespace ComicsAppWasm.ComicsService.ComicSources.DilbertComics.DilbertService
{
    public class DilbertServiceApi
    {
        public async Task<string> GetDilberComicsUrl()
        {
            var dateRange = this.GetRandomDateRange();  
            ...
            var imageLink = this.GetUri(source);
